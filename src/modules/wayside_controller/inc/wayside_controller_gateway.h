...
public:
    ...
    types::Error UpdateSimulation(std::shared_ptr<track_model::TrackModel> track_model);
    ...
    types::Error SetSuggestedSpeed(const types::LineId line, const types::BlockId block, const types::MetersPerSecond speed);
    types::Error SetAuthority(const types::LineId line, const types::BlockId block, const types::Meters authority);
    types::Error SetMaintenanceMode(const types::LineId line, const types::BlockId block, const bool maintenance);
    types::Error SetSwitchState(const types::LineId line, const types::BlockId block, const bool switch_state);
    void GetBlockOccupancies(const types::LineId line, std::vector<BlockOccupancy> &occupancies);
};
